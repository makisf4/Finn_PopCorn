...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 320x568 | Start screen fits; Play starts a run | Touch buttons move Finn | Pause and Resume buttons preserve the run | Catching increases score | Popcorn reaching the floor increments misses | Exactly 3 misses show Game Over and Restart | Mute, unmute, and volume control respond after interaction | Disable/unavailable API still shows local leaderboard without blocking play |
| 390x844 | Start screen fits; Play starts a run | Touch buttons move Finn | Pause and Resume buttons preserve the run | Catching increases score | Popcorn reaching the floor increments misses | Exactly 3 misses show Game Over and Restart | Mute, unmute, and volume control respond after interaction | Disable/unavailable API still shows local leaderboard without blocking play |
